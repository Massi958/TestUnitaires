...
public class Formation
{
    ...
    private static ArrayList<Participant> lesParticipants;
    ...
    public static int GetNombreDePresents()
    {
        // A compléter ici
        int Nb=0;
        for(int i=0;i<lesParticipants.size();){

           if(lesParticipants.get(i).isEstPresent()){
               Nb=Nb+1;
           }
    ...
    public double CalculerFraisRemboursementKilometriques()
    {
        ...
        for(int i=0;i<lesParticipants.size();){
            ...
            if(lesParticipants.get(i).isEstPresent()) {
                Nb = Nb + lesParticipants.get(i).getNbKm()*1.89;
                ;
            }
    ...
    public double TauxDePresence()
    {
        ...
        return (GetNombreDePresents()*100)/lesParticipants.size();
    }
    ...
    public double BeneficeFormation()
    {
        ...
        return  GetNombreDePresents()*prixFormation-CalculerFraisRemboursementKilometriques();
    }
}
